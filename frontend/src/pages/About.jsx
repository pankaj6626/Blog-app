  ...
  return (
    <div className="container mx-auto my-12 p-4 space-y-9">
      ...
      <p>
        ...
        <strong className="text-blue-800 font-semibold hover:scale-105 duration-500">
          {profile?.user?.name}
        </strong>{" "}excels in crafting seamless digital experiences.
      </p>
      ...
      {" "}
        <strong className="text-blue-800 font-semibold hover:scale-105 duration-500">
          {profile?.user?.name}
        </strong>{" "} is dedicated to leveraging his expertise to contribute to
      ...
      <p>
        ...
        <strong className="text-blue-800 font-semibold hover:scale-105 duration-500">
          {profile?.user?.name}
        </strong>{" "} is a big fan of cricket and
